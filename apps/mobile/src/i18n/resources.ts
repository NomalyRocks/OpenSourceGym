const tr = {
  ...
  Back: "Geri",
  "Go back": "Geri dön",
  "Return to sign in": "Giriş ekranına dön",
  Email: "E-posta",
  Password: "Şifre",
  "New password (min. 8 characters)": "Yeni şifre (min. 8 karakter)",
  ...
  "Sign in to your account and keep training":
    "Hesabına giriş yap ve antrenmana devam et",
  ...
  "Join openGym and start training": "openGym'e üye ol, antrenmana başla",
  "First name": "İsim",
  "Last name": "Soyisim",
  ...
  "The code is invalid or has expired.": "Kod hatalı veya süresi dolmuş.",
  ...
  "The code could not be sent. Please wait one minute.":
    "Kod gönderilemedi. Lütfen bir dakika bekleyin.",
  "A new code was sent.": "Yeni kod gönderildi.",
  ...
  "The code is invalid.": "Kod hatalı.",
  "The code has expired.": "Kodun süresi dolmuş.",
  ...
  "Sign in with your new password.": "Yeni şifrenizle giriş yapın.",
  ...
  "Grant gallery permission to select a photo.":
  ...
  "Remove your profile photo?": "Profil fotoğrafınız kaldırılsın mı?",
  Cancel: "Vazgeç",
  Remove: "Kaldır",
  ...
  "{{inside}} / {{capacity}} people": "{{inside}} / {{capacity}} kişi",
  "People: {{inside}}": "Kişi: {{inside}}",
  ...
  Start: "Başlangıç",
  End: "Bitiş",
  "Contact gym reception for a subscription.":
    "Abonelik için salon resepsiyonuna başvurun.",
  "The gym is open now": "Salon şu an açık",
  "Group class reminder": "Grup dersi hatırlatması",
  "Your yoga class starts at 18:00": "Yoga dersin 18:00'da başlıyor",
  "2h": "2s",
  "Sign out": "Çıkış yap",
  "Your account deletion request is awaiting staff approval.":
    "Hesap silme talebiniz personel onayı bekliyor.",
  "Cancel request": "Talebi iptal et",
  "Your previous deletion request was rejected.":
    "Önceki silme talebiniz reddedildi.",
  "Delete my account": "Hesabımı sil",
  "Connection error. Please try again.": "Bağlantı hatası. Tekrar deneyin.",
  "CAMERA PERMISSION": "KAMERA İZNİ",
  "Camera access is required to scan the turnstile QR code.":
    "Turnikedeki QR kodunu okutmak için kamera erişimi gerekir.",
  Allow: "İzin ver",
  "TURNSTILE QR": "TURNİKE QR",
  "Scan the QR code on the turnstile.": "Turnikedeki QR kodunu okutun.",
  "Scan turnstile QR code": "Turnike QR kodunu tara",
  "Turnstile opened — {{direction}}": "Turnike açıldı — {{direction}}",
  Exit: "Çıkış",
  Entry: "Giriş",
  "You may need to grant location permission to the app.":
    "Uygulamaya konum izni vermeniz gerekebilir.",
  "Entry is temporarily blocked due to suspected account sharing. Contact reception if you think this is a mistake.":
    "Hesap paylaşımı şüphesi nedeniyle geçici engel. Sorun olduğunu düşünüyorsanız resepsiyona başvurun.",
  "The turnstile is offline. Contact reception.":
    "Turnike bağlantısı yok, resepsiyona başvurun.",
  "Scan again": "Tekrar tara",
  "Request failed ({{status}})": "İstek başarısız ({{status}})",
  "The selected photo could not be read.": "Seçilen fotoğraf okunamadı.",
  ...
  "QR is unavailable on this device": "Bu cihazda QR kullanılamıyor",
  "Contact gym reception for assistance.":
    "Yardım için salon resepsiyonuna başvurun.",
  "Return to Home": "Ana sayfaya dön",
  Home: "Ana Sayfa",
  "Scan QR": "QR Tara",
  Profile: "Profil",
  "Reset your password": "Şifreni yenile",
  "Create a new password": "Yeni şifre oluştur",
  "Use at least 8 characters.": "En az 8 karakter kullanın.",
  "Create your membership and enter with QR":
    "Üyeliğini oluştur ve QR ile giriş yap",
  "This field is required.": "Bu alan zorunludur.",
  "Enter your password.": "Şifrenizi girin.",
  "Check your membership and enter the gym":
    "Üyeliğini kontrol et ve salona giriş yap",
  Unknown: "Bilinmiyor",
  "Hello, {{name}}": "Merhaba, {{name}}",
  "At the gym today": "Bugün salonda",
  "Check occupancy, view your membership, and pass through the turnstile.":
    "Doluluğu kontrol et, üyeliğini gör ve turnikeden geç.",
  "Gym occupancy": "Salon doluluğu",
  "Try again": "Tekrar dene",
  "{{inside}} of {{capacity}} people inside":
    "{{inside}} / {{capacity}} kişi içeride",
  "{{inside}} people inside": "{{inside}} kişi içeride",
  "Your membership": "Üyeliğin",
  "{{count}} days remaining": "{{count}} gün kaldı",
  ...
  "Membership data could not be loaded.": "Üyelik bilgisi alınamadı.",
  "Occupancy data could not be loaded.": "Doluluk bilgisi alınamadı.",
  "Profile data could not be loaded.": "Profil bilgisi alınamadı.",
  ...
  "Account deletion requests are reviewed by gym staff.":
    "Hesap silme talepleri salon personeli tarafından incelenir.",
  "Camera access is required": "Kamera erişimi gerekli",
  "Point the camera at the OpenGym code on the turnstile.":
    "Kamerayı turnikedeki OpenGym koduna doğrult.",
  "Validating entry…": "Giriş doğrulanıyor…",
  "We are checking the code. Please wait a moment.":
    "Kodu kontrol ediyoruz, kısa bir an bekle.",
  "Validation starts automatically when a code is detected.":
    "Kod algılandığında doğrulama otomatik başlar.",
  "Turnstile opened": "Turnike açıldı",
  "A {{direction}} record was created for {{device}}.":
    "{{device}} için {{direction}} kaydı oluşturuldu.",
  exit: "çıkış",
  entry: "giriş",
  "The camera will reopen shortly for a new scan.":
    "Yeni tarama için kamera birazdan yeniden açılacak.",
  "Entry could not be completed": "Geçiş tamamlanamadı",
  "Enable location permission and try again.":
    "Konum iznini etkinleştirip tekrar deneyin.",
  "Disable the mock location app and try again.":
    "Sahte konum uygulamasını kapatıp tekrar deneyin.",
  "Contact gym reception about the account-sharing block.":
  ...
  "Could not sign out. Please try again.": "Çıkış yapılamadı. Tekrar deneyin.",
  // Splash screen
  ...
  "Remembered your password?": "Şifreni hatırladın mı?",
  // Tabs and navigation
  Calendar: "Takvim",
  ...
  "Membership period": "Üyelik dönemi",
  Today: "Bugün",
  Visit: "Geliş",
  "Not set": "Tanımlı değil",
  "Within coverage": "Kapsam içinde",
  "Outside coverage": "Kapsam dışında",
  "{{n}} records": "{{n}} kayıt",
  "{{n}} visits": "{{n}} geliş",
  "No visit": "Geliş yok",
  "Visit history could not be loaded.": "Geliş geçmişi alınamadı.",
  "No visits recorded this month": "Bu ay geliş kaydın yok",
  ...
  "Could not load notifications.": "Bildirimler alınamadı.",
  ...
  "Your membership is not active": "Üyeliğin aktif değil",
  ...
  "Your membership expires soon": "Üyeliğin yakında bitiyor",
  ...
  // Profile
  "Tap the photo to change it": "Değiştirmek için fotoğrafa dokun",
  "Tap to add a photo": "Fotoğraf eklemek için dokun",
  ...
  "Saving…": "Kaydediliyor…",
  "Saved.": "Kaydedildi.",
  "Could not save. Please try again.": "Kaydedilemedi. Tekrar deneyin.",
  ...
  Light: "Açık",
  Dark: "Koyu",
  "Membership reminders": "Üyelik hatırlatmaları",
  ...
  "Privacy and permissions": "Gizlilik ve izinler",
  "App permissions": "Uygulama izinleri",
  ...
  "Let's find your daily energy needs": "Günlük enerjini birlikte bulalım",
  ...
  "What is your goal?": "Hedefin nedir?",
  ...
  "How was this calculated?": "Nasıl hesaplandı?",
  "Basal metabolic rate": "Bazal metabolizma",
  "Activity multiplier": "Hareket çarpanı",
  "Goal adjustment": "Hedef ayarı",
  ...
  Complete: "Tamamlandı",
  "Edit values": "Değerleri düzenle",
  "Return to Tools": "Araçlara dön",
  "Start calculation": "Hesaplamaya başla",
  Continue: "Devam",
} as const;
...
export type MobileTranslationKey = keyof typeof tr;
